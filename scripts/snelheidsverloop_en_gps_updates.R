...
fn = "C:/Users/joepk/Documents/GitHub/r_canbus/scripts/afstand_tussen_metingen.sql"
zz <- file(fn, "r")
#q = readLines(zz)
q <- "  SELECT vin, 
    ...
    WHERE signalid = 191 AND vin = '807940e893267994237dfc53cf9c1f4a3f9985a41f65e7de9b15f65a7d08aabd' 
    GROUP BY vin, geom
