...
plot(voorbeeld$time2, voorbeeld$speed, type='o', pch=21, cex=0.4,
  xlim=c(as.numeric(as.POSIXct("2017-01-01 15:59:00")), as.numeric(as.POSIXct("2017-01-01 16:14:00"))), xaxt='n',
  xlab='time (hh:mm)', ylab= 'verhicle speed (km/h)')

legend(x = 'topleft', legend = 'brake on-off', fill='grey', bty='n')
